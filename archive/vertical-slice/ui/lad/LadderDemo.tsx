/**
 * Ladder Demo Component - Multiple Rungs Display
 * Step 2: Displays multiple rungs with per-rung highlighting
 */
  ...
  return (
    <div className="font-mono">
      ...
      <div className="mt-4 p-4 bg-blue-50 rounded border border-blue-200">
        <h4 className="text-sm font-semibold text-blue-700 mb-2">Seal-In / Latching Logic:</h4>
        <p className="text-xs text-gray-600 mb-2">
          <span className="font-semibold">OR logic</span> enables classic latch patterns:
          use a momentary start button in parallel with an output feedback contact to maintain state.
        </p>
        <p className="text-xs text-gray-600">
          Example: <code className="bg-white px-1">(I0.0 OR Q0.0) → Q0.0</code> creates a latch
          where pressing I0.0 turns ON Q0.0, which then seals itself ON even after I0.0 releases.
        </p>
      </div>
    </div>
  );
